...
MJ_PER_KG_CH4 = 55       # 1 kg CH4 = 55 MJ
""" An assumption of 1 kg CH4 = 55 MJ, which is obtained from El Abbadi et al., preprint . """
...
""" To calculate RNG cost which is cited from Parker et al., 2017, RNG flow was calculated in MMBtu/hr
 using the biogas generation in kgCH4/hr, the assumption of 1 kg CH4 = 55 MJ and the conversion factor of 1 MMBtu = 1,055.06 MJ."""

rng_flow = biogas_gen * 1/MMBTU_TO_MJ * MJ_PER_KG_CH4
print(rng_flow)
